...
return new class extends Migration
{
    ...
    {
        Schema::create('stock_numbers', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('avito_ru');
            $table->string('auto_ru');
            $table->string('drom_ru');
            $table->string('Статус продажи');
            $table->string('Предпродажная подготовка');
            $table->string('Ремонт');
            $table->string('Логистика');
            $table->string('Юридические проблемы');
            $table->string('Прочие проблемы');
            $table->string('Подготовка контента');
            $table->string('Резерв');
            $table->text('Комментарии по статусам');
            ...
            $table->float('Затраты на avito_ru, ₽');
            ...
            $table->string('Дата остатков');
            $table->string('Дата поступления на склад');
        });
    }
    ...
    {
        Schema::dropIfExists('stock_numbers');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::table('stock_numbers', function($table) {
            ...
            $table->string('avito_ru')->nullable()->change();
            $table->string('auto_ru')->nullable()->change();
            $table->string('drom_ru')->nullable()->change();
            $table->string('Статус продажи')->nullable()->change();
            $table->string('Предпродажная подготовка')->nullable()->change();
            $table->string('Ремонт')->nullable()->change();
            $table->string('Логистика')->nullable()->change();
            $table->string('Юридические проблемы')->nullable()->change();
            $table->string('Прочие проблемы')->nullable()->change();
            $table->string('Подготовка контента')->nullable()->change();
            $table->string('Резерв')->nullable()->change();
            $table->text('Комментарии по статусам')->nullable()->change();
            ...
            $table->float('Затраты на avito_ru, ₽')->nullable()->change();
